...
public final class TypeResolver
{
    ...
    private static Member getMemberRef(final Class<?> type) {
        Object constantPool;
        try {
            constantPool = TypeResolver.GET_CONSTANT_POOL.invoke(type);
        }
    ...
    static {
        ...
        try {
            ...
            final Object constantPool = TypeResolver.GET_CONSTANT_POOL.invoke(Object.class);
            TypeResolver.GET_CONSTANT_POOL_SIZE.invoke(constantPool);
