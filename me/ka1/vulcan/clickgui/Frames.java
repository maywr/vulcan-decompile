...
public class Frames
{
    ...
    public void renderGUIFrame(final FontRenderer fontRenderer) {
        ...
        if (this.font) {
            Vulcan.fontRenderer.drawStringWithShadow(this.category.name(), (float)(this.x + 2), (float)(this.y + 3), -1);
        }
        else {
            FontUtils.drawStringWithShadow(ModuleManager.isModuleEnabled("CustomFont"), this.category.name(), this.x + 2, this.y + 3, -1);
        }
