...
public class CFontRenderer extends CFont
{
    ...
    public float drawString(final String text, double x, double y, final int color) {
        --x;
        y -= 2.0;
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (character == '§' && i < size) {
                    ...
                    if (colorIndex < 16) {
                        ...
                        GlStateManager.color((colorcode >> 16 & 0xFF) / 255.0f, (colorcode >> 8 & 0xFF) / 255.0f, (colorcode & 0xFF) / 255.0f);
                    }
