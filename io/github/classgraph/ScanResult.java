...
public final class ScanResult implements Closeable, AutoCloseable
{
    ...
    public static ScanResult fromJSON(final String json) {
        ...
        final SerializationFormat deserialized = (SerializationFormat)JSONDeserializer.deserializeObject((Class)SerializationFormat.class, json);
