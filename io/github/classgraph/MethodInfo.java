    ...
    public MethodParameterInfo[] getParameterInfo() {
        if (this.parameterInfo == null) {
            ...
            for (int l = 0; l < numParams; ++l) {
                (this.parameterInfo[l] = new MethodParameterInfo(this, (paramAnnotationInfoAligned == null) ? null : paramAnnotationInfoAligned[l], (paramModifiersAligned == null) ? 0 : paramModifiersAligned[l], paramTypeDescriptors.get(l), (paramTypeSignaturesAligned == null) ? null : paramTypeSignaturesAligned.get(l), (paramNamesAligned == null) ? null : paramNamesAligned[l])).setScanResult(this.scanResult);
            }
        }
            ...
            for (int i = 0; i < this.parameterAnnotationInfo.length; ++i) {
                ...
                if (pai != null && pai.length > 0) {
                    ...
                    if (hasRepeatableAnnotation) {
                        ...
                        this.parameterAnnotationInfo[i] = (AnnotationInfo[])aiList.toArray((Object[])new AnnotationInfo[0]);
                    }
                }
            }
        }
    ...
    public String toString() {
        ...
        for (int j = 0, numParams = allParamInfo.length; j < numParams; ++j) {
            ...
            if (j == varArgsParamIndex) {
                ...
                buf.append(new ArrayTypeSignature(arrayType.getElementTypeSignature(), arrayType.getNumDimensions() - 1, null));
                buf.append("...");
            }
            else {
