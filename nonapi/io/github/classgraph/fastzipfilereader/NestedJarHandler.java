    ...
    public NestedJarHandler(final ScanSpec scanSpec, final InterruptionChecker interruptionChecker) {
        ...
        this.nestedPathToLogicalZipFileAndPackageRootMap = new SingletonMap<String, Map.Entry<LogicalZipFile, String>, IOException>() {
            public Map.Entry<LogicalZipFile, String> newInstance(final String nestedJarPathRaw, final LogNode log) throws IOException, InterruptedException {
                ...
                if (lastPlingIdx < 0) {
                    ...
                    if (isURL) {
                        ...
                        try {
                            ...
                            physicalZipFile = (PhysicalZipFile)NestedJarHandler.this.canonicalFileToPhysicalZipFileMap.get((Object)canonicalFile, log);
                        }
                    ...
                    try {
                        logicalZipFile = (LogicalZipFile)NestedJarHandler.this.zipFileSliceToLogicalZipFileMap.get((Object)topLevelSlice, log);
                    }
                ...
                try {
                    parentLogicalZipFileAndPackageRoot = (Map.Entry<LogicalZipFile, String>)NestedJarHandler.this.nestedPathToLogicalZipFileAndPackageRootMap.get((Object)parentPath, log);
                }
                ...
                ZipFileSlice childZipEntrySlice;
                try {
                    childZipEntrySlice = (ZipFileSlice)NestedJarHandler.this.fastZipEntryToZipFileSliceMap.get((Object)childZipEntry, log);
                }
                ...
                try {
                    childLogicalZipFile = (LogicalZipFile)NestedJarHandler.this.zipFileSliceToLogicalZipFileMap.get((Object)childZipEntrySlice, zipSliceLog);
                }
